...
function ConsolidatedTooltipDetail({
    ...
    processed,
    objHasErrors,
}: Omit<ConsolidatedTooltipProps, "asGridCell" | "errorPct" | "isMockFinalized">) {
...
export const ConsolidatedTooltip = ({
        ...
        return (
            <div className="flex flex-col flex-1 items-center justify-center py-1.5 px-2 transition-all gap-1.5">
                <div className="inline-flex items-center gap-1">
                    {obj.isLoaded ? (
                        <>
                            <span className={cn("text-[14px] font-black font-mono leading-none tracking-tight", pctToneClass)}>
                                {formatPercentage(successPct, "success", objHasErrors)}%
                            </span>
    ...
    return <ConsolidatedTooltipDetail {...detailProps} />;
};
